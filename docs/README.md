...
| [Operation guides](/guides)                            | Interactive walkthroughs for admins, students, and exam-day staff (in-app at `/guides`).                                                                      |
| [Vercel deployment](./VERCEL_DEPLOY.md)                | Preview/production deploy on Vercel.                                                                                                                          |
| [Migration smoke tests](./testing/migration-smoke.md)  | Post-migration API + manual checklist (Lane P).                                                                                                               |
...
- **Deploy:** Vercel (primary); legacy Docker workflow on branch `Deploy` is CRA-era — see backlog Lane M for cutover checklist.

## Related

| Location                                                                            | Role                                                          |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [`lumenelit/kep-unklab-exam`](https://github.com/lumenelit/kep-unklab-exam)         | This app (branch **`main`**)                                  |
