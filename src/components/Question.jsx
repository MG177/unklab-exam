...
export default function Questions({ question, questions, media }) {
  ...
  // console.table({
  //   "all = " + JSON.stringify(questions[question]),
  //   "audio = " + questions[question].audio,
  // });
  console.log("all = " + JSON.stringify(questions[question]));
  console.log("audio = " + questions[question].audio);
  console.log("image = " + questions[question].image);
